...
async function handleTable(
	...
	// Bulk Insert handled by execute() path → handleTableBatchInsert
	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			// ── Tenant ────────────────────────────────────────────────
			{
				...
				type: 'options',
				displayOptions: { show: { resource: ['table'] } },
				typeOptions: { loadOptionsMethod: 'getTenants', loadOptionsDependsOn: ['operation'] },
				default: '',
			...
			// ── Schema ────────────────────────────────────────────────
			{
				...
				type: 'options',
				displayOptions: { show: { resource: ['table'] } },
				typeOptions: { loadOptionsMethod: 'getSchemas', loadOptionsDependsOn: ['tenant', 'operation'] },
				default: '',
